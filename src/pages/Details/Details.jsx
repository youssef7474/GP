        ...
        <div class="friends-page  m-20 gap-20">
            <div class="friend bg-white rad-6 p-20 p-relative">
                ...
                <div class="icon fs-14 p-relative">
                    ...
                    <div class="p-20" style={{borderBottom: "1px solid #eee"}} >
                      <span style={{color:"#0075ff" ,fontSize:"15px"}} >patient at home : </span>
                    ...
                    <div class="p-20" style={{borderBottom: "1px solid #eee"}} >
                      ...
                      <span  style={{marginLeft:"10px",fontSize:"15px"}}>{detailspatient.description}</span>
                    </div>
